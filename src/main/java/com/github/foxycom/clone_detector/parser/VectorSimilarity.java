...
public class VectorSimilarity {
  ...
  public double[] methodVectorSim(MethodVector mVector1, MethodVector mVector2,
    ...
    // return the similarity vector between two methods
      if (without_feature.equals("reservedword")) {
          return (new double[]{simTokenType, simTokenLiteral, simTokenVariable,
              simTokenFunctionName,
              simTokenQualifiedName, simTokenOperator, simTokenMarker});
      }
      if (without_feature.equals("type")) {
          return (new double[]{simTokenReservedWord, simTokenLiteral, simTokenVariable,
              simTokenFunctionName, simTokenQualifiedName, simTokenOperator, simTokenMarker});
      }
      if (without_feature.equals("literal")) {
          return (new double[]{simTokenReservedWord, simTokenType, simTokenVariable,
              simTokenFunctionName, simTokenQualifiedName, simTokenOperator, simTokenMarker});
      }
      if (without_feature.equals("variable")) {
          return (new double[]{simTokenReservedWord, simTokenType, simTokenLiteral,
              simTokenFunctionName, simTokenQualifiedName, simTokenOperator, simTokenMarker});
      }
      if (without_feature.equals("functionname")) {
          return (new double[]{simTokenReservedWord, simTokenType, simTokenLiteral,
      ...
      if (without_feature.equals("qualifiedname")) {
          return (new double[]{simTokenReservedWord, simTokenType, simTokenLiteral,
              simTokenVariable,
              simTokenFunctionName, simTokenOperator, simTokenMarker});
      }
      if (without_feature.equals("operator")) {
          return (new double[]{simTokenReservedWord, simTokenType, simTokenLiteral,
              simTokenVariable,
              simTokenFunctionName, simTokenQualifiedName, simTokenMarker});
      }
      if (without_feature.equals("marker")) {
          return (new double[]{simTokenReservedWord, simTokenType, simTokenLiteral,
              simTokenVariable,
              simTokenFunctionName, simTokenQualifiedName, simTokenOperator});
      }
